...
const whatToDoForLunch = function(hungry, availableTime) {
  if (hungry === true && availableTime < 20) {
    ...
    return ('Remember: this is a bootcamp after all and you should probably reconsider how much time you spend!');
  } else {
    return ('You should study a little bit longer!');
  }
};
//  hungry ? console.log("blah") :
//   (hungry && availableTime < 20) ? console.log("bleh") :
//   (hungry && availableTime > 30) ? null : console.log("ddd")  console.log("ererg")
